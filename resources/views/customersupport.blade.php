...
<section style="background-image: url('banner/banner.png'); 
  ...
  <div class="container text-center">
    <br><br><br><br><br><br>
    <h1 class="tittle">How can we help you?</h1> <br>
...
<div class="frequenlty-asked-questions">
  ...
  <div style="text-align: center;">
    <label data-aos="fade-up" style="background-color: #ccc;color:#0071ce; border-radius:16px;width: 100px;text-align:center">Benefits</label>
    <br><br>
