...
<body class="index-page">
    ...
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul style="display: flex;justify-content:space-between;gap: 10px;">
          ...
          <li><a href="">Blog</a></li>
          <li hidden class="dropdown"><a href="#"><span>Dropdown</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
  ...
  <footer style="max-width: 1241px;margin:auto;" id="footer"
    class="footer ">
